    ...
    function Form(props) {
        ...
        _this.updateObject = function (name, value, e) {
            _this.setState(function (prevState) {
                var _a;
                var data = __assign({}, prevState.data, (_a = {}, _a[name] = value, _a));
        ...
        _this.attachToForm = function (name, props) {
            var _a;
            _this.fields = __assign({}, _this.fields, (_a = {}, _a[name] = props, _a));
        };
...
var transformMaskedValue = function (value, providedMask, props) {
    ...
    if (typeof providedMask === 'function') {
        mask = providedMask(safeValue, __assign({}, props, { pipe: pipe }));
...
var createMinMaxInputPipe = function (_a) {
    ...
    return (function (conformedValue) {
        if (typeof min === 'number' || typeof max === 'number') {
            var value = maskedNumberValue(__assign({}, props, { value: conformedValue }));
...
var buildState = function (props) {
    ...
    if (wrapColors) {
        ...
        colorRows = colorRows.map(function (row) { return (__assign({}, row, { colors: row.colors.filter(function (_, index) { return (index < colorsPerRow); }) })); });
    }
    var activeRow = 0;
    var activeColor = 0;
...
var DateInput = /** @class */ (function (_super) {
    ...
    DateInput.prototype.render = function () {
        ...
        return (React.createElement(MaskedInput, __assign({ update: function (update) { _this.upDateValue = update; }, value: controlledValue, dropContent: (React.createElement(Box, { pad: 'small' },
                React.createElement(Calendar, { date: controlledValue.toString(), onSelect: this.onSelect, bounds: bounds, dates: dates, disabled: disabledDates, firstDayOfWeek: firstDayOfWeek, locale: locale, size: size }))) }, __assign({}, rest, mask))));
    };
        ...
        _this.onChange = function (e) {
            ...
            if (onChange) {
                ...
                if (_this.value !== value) {
                    ...
                    _this.value = value;
                    onChange(__assign({}, e, { target: __assign({}, e.target, { value: value }) }));
                }
            }
        };
        return _this;
...
var allSpinners = __assign({}, spinkitSpinners, loadersCssSpinners);
...
var defaultProps = {
    ...
    getTrProps: function (even, _a) {
        ...
        if (decorations) {
            ...
            if (even) {
                props = __assign({}, props, (decorations.rowEven || defaultRowEvenProps));
            }
            else {
                props = __assign({}, props, (decorations.rowOdd || defaultRowOddProps));
            }
            return props;
        }
...
var ReactTable = /** @class */ (function (_super) {
    ...
    function ReactTable(props) {
        ...
        _this.getResolvedState = function (props, state) { return (__assign({}, _.compactObject(_this.state), _.compactObject(_this.props), _.compactObject(state), _.compactObject(props))); };
    ...
    ReactTable.getDerivedStateFromProps = function (nextProps, oldState) {
        var newState = __assign({}, oldState, nextProps);
    ...
    ReactTable.getStateWithData = function (newState, oldState, props) {
        var newResolvedState = __assign({}, oldState, newState, props);
    ...
    ReactTable.prototype.render = function () {
        ...
        var recurseRowsViewIndex = function (rows, path, index) {
            ...
            return ([
                rows.map(function (row, i) {
                    var _a;
                    index += 1;
                    var rowWithViewIndex = __assign({}, row, { viewIndex: index });
        ...
        var rowIndex = -1;
        var finalState = __assign({}, resolvedState, { startRow: startRow,
            endRow: endRow,
            pageRows: pageRows,
            minRows: minRows,
            padRows: padRows,
        ...
        var makeHeaderGroup = function (column, i) {
            ...
            var rest = __assign({}, theadGroupThProps, columnHeaderProps, { CellTextComponent: CellTextComponent });
            var flexStyles = {
                flex: flex + " 0 auto",
                width: _.asPx(width),
        ...
        var makeHeader = function (column, i) {
            ...
            var columnHeaderProps = column.getHeaderProps(finalState, undefined, column, _this);
            var rest = __assign({}, theadThProps, columnHeaderProps, { CellTextComponent: CellTextComponent });
        ...
        var makeFilter = function (column, i) {
            ...
            var rest = __assign({}, theadFilterThProps, columnHeaderProps, { CellTextComponent: CellTextComponent });
            ...
            return (React.createElement(ThComponent, __assign({ key: i + "-" + column.id, style: {
                ...
                ? _.normalizeComponent(ResolvedFilterComponent, __assign({}, filterInputProps, { column: column,
        ...
        var makePageRow = function (row, i, path) {
            ...
            return (React.createElement(TrGroupComponent, __assign({ key: rowInfo.nestingPath.join('_') }, trGroupProps),
                React.createElement(TrComponent, __assign({ selectRow: selectRow(i), ref: function (el) { _this.rowRef[i] = el; }, rowIndex: row.viewIndex }, trProps), allVisibleColumns.map(function (column, i2) {
                    ...
                    var cellInfo = __assign({}, rowInfo, { isExpanded: isExpanded, column: __assign({}, column), value: rowInfo.row[column.id], pivoted: column.pivoted, expander: column.expander, expandable: undefined, resized: resized,
                        show: show,
                        width: width,
                    ...
                    var cellProps = __assign({}, tdProps, columnProps);
                    ...
                    var DefaultResolvedPivotComponent = PivotComponent
                        || (function (props) { return (React.createElement(React.Fragment, null,
                            React.createElement(ResolvedExpanderComponent, __assign({}, __assign({}, props, { expanderProps: expanderProps }))),
                    ...
                    if (cellInfo.pivoted) {
                        ...
                        if (isBranch) {
                            // isPivot
                            resolvedCell = _.normalizeComponent(ResolvedPivotComponent, __assign({}, cellInfo, { value: row[pivotValKey] }), row[pivotValKey]);
                        }
                        else if (isPreview) {
                    ...
                    if (cellInfo.expander) {
                        ...
                        resolvedCell = _.normalizeComponent(ResolvedExpanderComponent, __assign({}, cellInfo, { expanderProps: expanderProps }), row[pivotValKey]);
                        if (pivotBy) {
    ...
    ReactTable.getDataModel = function (newState, props) {
        ...
        var columnsWithExpander = columns.slice();
        ...
        var makeDecoratedColumn = function (column, parentColumn) {
            var dcol;
            if (column.expander) {
                dcol = __assign({}, props.column, props.expanderDefaults, column);
            }
            else {
                dcol = __assign({}, props.column, column);
            }
        ...
        var decoratedColumns = columnsWithExpander.map(function (column) {
            if (column.columns) {
                return __assign({}, column, { columns: column.columns.map(function (d) { return decorateAndAddToAll(d, column); }) });
            }
        ...
        visibleColumns = visibleColumns.map(function (column) {
            if (column.columns) {
                ...
                return __assign({}, column, { columns: visibleSubColumns });
            }
            return column;
        });
        ...
        if (pivotBy.length) {
            ...
            var pivotColumnGroup = {
                ...
                columns: pivotColumns_1.map(function (col) { return (__assign({}, props.pivotDefaults, col, { pivoted: true })); }),
            };
            // Place the pivotColumns back into the visibleColumns
            if (pivotIndex >= 0) {
                pivotColumnGroup = __assign({}, visibleColumns[pivotIndex], pivotColumnGroup);
        ...
        var addHeader = function (columns, column) {
            headerGroups.push(__assign({}, props.column, column, { columns: columns }));
            currentSpan = [];
        };
        ...
        if (pivotBy.length) {
            var groupRecursively_1 = function (rows, keys, i) {
                ...
                groupedRows = groupedRows.map(function (rowGroup) {
                    ...
                    return __assign({}, rowGroup, (_a = {}, _a[subRowsKey] = subRows, _a[aggregatedKey] = true, _a), aggregate(subRows));
                });
                return groupedRows;
            };
            resolvedData = groupRecursively_1(resolvedData, pivotBy);
        }
        return __assign({}, newState, { resolvedData: resolvedData,
    ...
    ReactTable.filterData = function (data, filtered, defaultFilterMethod, allVisibleColumns, props) {
        ...
        if (filtered.length) {
            ...
            filteredData = filteredData
                ...
                return __assign({}, row, (_a = {}, _a[props.subRowsKey] = ReactTable.filterData(row[props.subRowsKey], filtered, defaultFilterMethod, allVisibleColumns, props), _a));
            })
                .filter(function (row) {
                if (!row[props.subRowsKey]) {
                    return true;
...
var responsiveColumns = function (size, columns) { return (Array.isArray(columns)
    ? columns.map(function (column) {
        ...
        return __assign({}, column, { show: show });
    }) : columns); };
/**
...
var PagingTable = function (_a) {
    ...
    var newProps = __assign({}, defaults, rest);
    ...
    function VerticalMenu() {
        ...
        _this.onMenuChange = function (id, expanded) {
            ...
            if (expanded) {
                var toBeCollapsed_1 = [
                    id
                ].concat(getFlatChildrenIds(getChildrenById(filteredItems, id)));
