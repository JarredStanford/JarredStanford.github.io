...
var getAllColumns = function (columns) {
    ...
    columns.forEach(function (column) {
        if (column.columns) {
            allColumns = allColumns.concat(getAllColumns(column.columns));
        }
        else {
...
var updateColumnShow = function (allColumns, visible) { return (allColumns.map(function (column) { return (column.columns ? __assign({}, column, { columns: updateColumnShow(column.columns, visible) }) : __assign({}, column, { show: visible.indexOf(column.Header) !== -1 })); })); };
