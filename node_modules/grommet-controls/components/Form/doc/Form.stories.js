...
import { Form, TextInputField, PasswordInputField, SelectField, CheckBoxField, NumberInputField, validators, } from '../../../index';
export default {
    title: 'validation/Form',
    component: Form,
};
export var main = function () { return (React.createElement(Form, { onSubmit: function (values) { return alert(JSON.stringify(values)); }, pad: {
        horizontal: 'small',
    } },
...
export var onSubmit = function () { return (React.createElement(Form, { focusFirstChild: false, onSubmit: function (values) { return alert(JSON.stringify(values)); }, basis: 'small' },
...
export var onSubmitError = function () { return (React.createElement(Box, { pad: 'small' },
    React.createElement(Form, { focusFirstChild: false, onSubmit: function (values) { return alert(JSON.stringify(values)); }, onSubmitError: function (errors) { return alert(JSON.stringify(errors)); }, basis: 'small' },
...
export var onInvalidForm = function () {
    ...
    return (React.createElement(Box, { pad: 'small' },
        React.createElement(Form, { focusFirstChild: false, onSubmit: function (values) { return alert(JSON.stringify(values)); }, onInvalidForm: function (error) { return setInvalid(error); }, onValidForm: function () { return setInvalid(undefined); }, basis: 'small' },
